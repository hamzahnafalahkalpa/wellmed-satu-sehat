...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'wellmed-satu-sehat:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the WellmedSatuSehat project';
    ...
    {
        MicroTenant::tenantImpersonate(app(config('database.models.Tenant'))->where('props->product_type','WellmedSatuSehat')->firstOrFail());
        ...
        $this->info("Migrations for WellmedSatuSehat project have been successfully executed.");

        if ($this->option('seed')){
            $this->info("Run seeding");
            Artisan::call('wellmed-satu-sehat:seed');
            $this->info("Seeded");
        }
        return Command::SUCCESS;
    }
